...
struct Zone {
    ...
    char name[20];     //Will be dowloaded from PowerMax eprom    (only needs to be 17 but increased to 20 for safety)
...
public:
	...
	//Variables to control Powerlink enrol process, either prevent enrol or slow it down
